...
public class AnalizadorConsumo {
    ...
    public boolean consumoExcesivo(Usuario usuario){
        ...
        return consumo > usuario.getSector().getLimiteConsumo();
    }
    ...
    public String generarAnalisis(Usuario usuario){
        ...
        texto.append(String.format("Límite recomendado para %s: %.2f kWh\n", usuario.getSector(), limite));

        texto.append("Clasificación: " + clasificarConsumo(usuario) + "\n");
